...
import (
	...
	apisCluster "github.com/acrackintheice/provider-litellm/apis/cluster"
	apisNamespaced "github.com/acrackintheice/provider-litellm/apis/namespaced"
	"github.com/acrackintheice/provider-litellm/config"
	"github.com/acrackintheice/provider-litellm/internal/clients"
	controllerCluster "github.com/acrackintheice/provider-litellm/internal/controller/cluster"
	controllerNamespaced "github.com/acrackintheice/provider-litellm/internal/controller/namespaced"
	"github.com/acrackintheice/provider-litellm/internal/features"
	"github.com/acrackintheice/provider-litellm/internal/version"
)
...
func main() {
	...
	kingpin.FatalIfError(apisCluster.AddToScheme(mgr.GetScheme()), "Cannot add cluster-scoped LiteLLM APIs to scheme")
	kingpin.FatalIfError(apisNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add namespaced LiteLLM APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated(mgr, clusterOpts), "Cannot setup cluster-scoped LiteLLM controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated(mgr, namespacedOpts), "Cannot setup namespaced LiteLLM controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup(mgr, clusterOpts), "Cannot setup cluster-scoped LiteLLM controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup(mgr, namespacedOpts), "Cannot setup namespaced LiteLLM controllers")
	}
